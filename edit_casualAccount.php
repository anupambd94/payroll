...
<div class="container">
  ...
  <aside class="main_sidebar">
   ...
   <div class="logo">
       ...
       <ul>
         ...
         <li class="active"><i class="fas fa-shopping-cart"></i><a href="home_salaryCasual.php"><p><font size="2"><font color="Black">Pay Casual Employee</font></p></a></li>
  ...
  <div class="col-sm-10">
    ...
    include("calculations/regularCalculation.php");
        ...
        ?>
        <!--marquee-->
        <marquee>  <h1 class="page-subhead-line"><font size="4"><span class="different-text-color"><font color="white">WELCOME TO--ERP / CASUAL EMPLOYEE  </strong> @ <font color="Blue"> Today is :
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h1 class="page-head-line"><font size="5"><font color="Black"><u>Salary of : <?php echo ' '.$row2['fname']." ". $row2['lname'] ?></u></font></h1>
                ...
                <div class="row bg-info">
                    <div class="col-sm-7 ">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Salary Rate :</label>
                            <div class="col-sm-4">
                                <input type="text" name="salary" class="form-control" value="<?php echo $salary_rate;?>" required="required" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Working Days :</label>
                            <div class="col-sm-4">
                                <input type="text" name="days" class="form-control" value="<?php echo $days;?>" required="required" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Salary :</label>
                            <div class="col-sm-4">
                                <input type="text" name="tsalary" class="form-control" value="<?php echo $salary;?>" required="required" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="bonus" class="form-control" value="<?php echo $bonus;?>" required="required" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-sm-5 bg-info" >
                      <div class="form-group">
                          <div class="col-sm-12">
                            <div class="form-group">
                            <label class="col-sm-5 control-label">Total Days Works:</label>
                            <div class="col-sm-7">
                                <input name="id" type="hidden" value="<?php echo $id;?>" />
                                <input type="number" name="totalDays" class="form-control" placeholder="Enter woking Days" required="required">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-9 control-label"></label>
                            <div class="col-sm-3">
                                <input type="submit" name="submitDays" class="btn btn-success" value="Submit">
                ...
                <div class="col-md-12">
                    ...
                    <div class="well bs-component">
                      <form class=" form-horizontal">
                        ...
                        <button type="button" data-toggle="modal" data-target="#addDeduction" class="btn btn-danger"><i class="fas fa-university"></i>  Add Deduction</button>
                        </br></br>
                            ...
                            while($row5 = $q5->fetch_assoc()) {
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        ...
                                        <a class="btn btn-primary" href="edit_regularDeduction.php?deduction_id=<?php echo $row5["deduction_id"]; ?>"><font color ="white"><i class="fas fa-user-edit"></i> Edit</font></a>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header" style="padding:20px 50px;">
                    ...
                    <h3 align="center"><b><font color="Black">Add Deduction for an Employee</b></h3>
                </div>
                <div class="modal-body" style="padding:40px 50px;">
                    ...
                    <form class="form-horizontal" action="add_deductionCasual.php" name="form" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control" id="datepicker" name="d_date" type="text" value="<?php echo $thisDate?>" />
                                <script>
