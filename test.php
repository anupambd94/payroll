...
?>
  ...
  <body>
    ...
    <h4><span "background-color:red;"><p><font color="#a569bd">@@@ WELLCOME TO ENTERPRISE RESOURCES PLANNING SYSTEM ........!!!!!!</font></p></span></h4>
 </marquee> </h1>
  </div>
      ...
      <div class="jumbotron bg-light">
          ...
          <div class="alert alert-warning" role="alert" >
              ...
              <h2><p> <center> Daily Report  </center> </p></h2>
          ...
          <!-- /. ROW  -->
              ...
              <div class="container">
				      <div align="left" style="">
						 <a class="btn btn-info" href="home_cash.php"><i class="fas fa-bell"></i> Cash Arrival</a>
             	 <a class="btn btn-info" href="home_bkash.php"><i class="fas fa-bell"></i> Bkash Arrival</a>
						 <a class="btn btn-info" href="dailyTransactions.php"><i class="fas fa-bell"></i> Cash/Bkash Transaction</a>
						 <a class="btn btn-info" href="home_payment.php"><i class="fas fa-bell"></i> Payment Report</a>
			   		</div>
                      <?php
                      include("main.php");
                      ?>
