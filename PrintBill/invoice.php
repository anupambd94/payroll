...
$pdf->Cell(59	,5,'Value',1,1,'R');//end of line

$pdf->SetFont('Arial','',12);

//Numbers are right-aligned so we give 'R' after new line parameter

$pdf->Cell(130	,5,'Bill Date',1,0);
$pdf->Cell(59	,5,$bill_date,1,1,'R');//end of line

$pdf->Cell(130	,5,'Bill No',1,0);
$pdf->Cell(59	,5,$bill_no,1,1,'R');//end of line

$pdf->Cell(130	,5,'Area',1,0);
$pdf->Cell(59	,5,$work_area,1,1,'R');//end of line

$pdf->Cell(130	,5,'Group Name',1,0);
$pdf->Cell(59	,5,$company_group,1,1,'R');//end of line

$pdf->Cell(130	,5,'Sft/Qty',1,0);
$pdf->Cell(59	,5,$qty,1,1,'R');//end of line

$pdf->Cell(130	,5,'Rate',1,0);
$pdf->Cell(59	,5,$rate,1,1,'R');//end of line

$pdf->Cell(130	,5,'Bill Amount',1,0);
$pdf->Cell(59	,5,$bill_amount,1,1,'R');//end of line

$pdf->Cell(130	,5,'Received Amount',1,0);
$pdf->Cell(59	,5,$received_amount,1,1,'R');//end of line

$pdf->Cell(130	,5,'Due',1,0);
$pdf->Cell(59	,5,$reduced,1,1,'R');//end of line
//make a dummy empty cell as a vertical spacer
$pdf->Cell(189	,10,'',0,1);//end of line
}
//summary
...
$pdf->Cell(130	,2,'',0,0);
$pdf->Cell(25	,2,'-------------- ',0,0);
$pdf->Cell(34	,2,'',0,1);//end of line

$pdf->Cell(130	,2,'',0,0);
$pdf->Cell(25	,2,'Signeture ',0,0);
$pdf->Cell(34	,2,'',0,1);//end of line
