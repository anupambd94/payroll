...
<div class="container">
  ...
  <aside class="main_sidebar">
    <!-- Logo -->
   <div class="logo">
       <a href="https://www.bubt.edu.bd/"> <center><img src="img/core-img/BUBT-Logo.png" alt=""><h2>@ERP@</h2></center></a>
       <!-- Logo Close-->
       <ul>
         ...
         <li ><i class="fas fa-comment-dollar"></i><a href="home_cash.php"><p><font size="2"><font color="white"><font color ="Black">Credited Cash </font></p></a></li>
         <li class="active"><i class="fab fa-phoenix-framework"></i><a href="home_bkash.php"><p><font size="2"><font color="white"><font color ="Black">Credited Bkash</font></p></a></li>
              ...
              <div class="masthead">
                <h3>
                  <b><a href=""><font color="white"><font size="5"><u><i>Enterprise Resources planning System</i></u></font></a></b>
                      <a data-toggle="modal" href="#colins" class="pull-right"><b><font color="White"><i class="fa fa-bicycle"></i> Admin</font></b></a>
                </h3>
  ...
  <!--marquee Close-->
                ...
                <div class="row">
                  <div class="col-md-12">
                    <br><br>
                      ...
                      <h1 class="page-head-line"><p><font color ="Black"><font size ="6">Deporsit Bkash</font></p></h1>
      ...
      <div class="well bs-component">
          <form class="form-horizontal">
              <fieldset>
                <button type="button" data-toggle="modal" data-target="#addbkash" class="btn btn-info btn-lg"><font size="2"> <i class="fa fa-bell"></i> Cr Bkash</font></button>

                  <p align="center"><big><b><font color="Blue">Balance Sheet</font></b></big></p>
      ...
      <div class="modal fade" id="addbkash" role="dialog">
          <div class="modal-dialog">

              <!-- Modal content-->
              <div class="modal-content">
                <div class="modal-header" style="padding:20px 50px;">
                  <h1 align="center"><b><font color="blue">ADD BKASH</font></b></center></h1>

                  </div>
                  <div class="modal-body" style="padding:40px 50px;">

                      <form class="form-horizontal" action="add_bkash.php" name="form" method="post">
                        <div class="form-group">
                            <label class="col-sm-4 control-label">Bill Date :</label>
                            <div class="col-sm-8">
                                <input class="form-control btn-lg" id="datepicker" value="<?php echo $thisDate;?>" name="given_date" type="text" />
                                <script>
