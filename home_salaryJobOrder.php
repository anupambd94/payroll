   ...
   <div class="logo">
       <a href="https://www.bubt.edu.bd/"> <center><img src="img/core-img/BUBT-Logo.png" alt=""><h2><font color ="Blue">@ERP@</h2></center></a>
         ...
         <ul>
           ...
           <li class="active"><i class="fas fa-shopping-cart"></i><a href="home_salaryJobOrder.php"><p><font size="2"><b><font color="Black">Pay Job Order Employee<b></font></p></a></li>
...
<div class="col-sm-10">
  ...
  <div class="masthead">
    ...
    <!--marquee-->
        <marquee>  <h1 class="page-subhead-line"><font size="4"><span class="different-text-color"><font color="white">WELCOME TO--ERP / Job-Order Employees Salary Information  </strong> @ <font color="Blue"> Today is :
  ...
  <div class="row">
      <div class="col-md-12">
          <h2 class="page-head-line"><font color ="black">Payment Job-Order Employee's </h2>
          <?php
          date_default_timezone_set("Asia/Dhaka");
          echo  date(" l, F d, Y") . "<br>";
    ...
    <div class="well bs-component">
        <form class="form-horizontal">
            ...
            <fieldset>
                <button type="button" data-toggle="modal" data-target="#addSalary" class="btn btn-info">  <font color="#FDE9B7"><i class="fas fa-user-cog"></i> Set Bonus </font></button>
                <br><br>
                        ...
                        <table class="table table-bordered table-hover table-condensed" id="myTable">
                            ...
                            while($row2 = $q2->fetch_assoc())
                            {
                              include("calculations/regularCalculation.php");
                                ...
                                ?>
                                <tr>
                                    <td align="center"><font color="blue"><?php echo $emp_id?></font></td>
                                    <td align="center"><font color="blue"><?php echo $fname?><?php echo $lname?></font></td>
                                    <td align="center"><big><b><font color="blue"><?php echo $salary?></font></b></big>.00</td>
                                    <td align="center"><big><b><font color="blue"><?php echo $deduction?></font></b></big>.00</td>
                                    <td align="center"><big><b><font color="blue"><?php echo $due?></font></b></big>.00</td>
                                    <td align="center"><big><b><font color="blue"><?php echo $advance?></font></b></big> .00</td>
                                    <td align="center"><big><b><font color="blue"><?php echo $bonus?></font></b></big>.00</td>
                                    <td align="center"><big><b><font color="blue"><?php echo $netpay?></font></b></big>.00</td>
                                    <td align="center">
                                        <a class="btn btn-warning" href="edit_jobOrderAccount.php?emp_id=<?php echo $row2["emp_id"]; ?>"><i class="fas fa-money-bill-alt"></i> Pay</a>
                                    </td>
                                </tr>
                            <?php } ?>
                            </tbody>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-sm-8">
                            <select  class="form-control" id="emp_id" style=" height:35px;" name="emp_id" onchange="myFunction(this.value)">
                              ...
                              <?php
                              $query1  = "SELECT emp_id, fname,lname,salary from employee where emp_type='Job Order'";
