  ...
  <body>
    ...
    <div class="container">
      <div class="masthead">
        ...
        <nav>
          <ul class="nav nav-justified">
            <li class="active">
              <a href="">Employee Account Update</a>
            </li>
      ...
      while($row = $result->fetch_assoc())
        {
            $query1  = "SELECT * from salary where emp_id='".$id."'";
            ...
            $query4  = "SELECT d_amount from deductions where emp_id = $id";
            $q4 = $conn->query($query4);
            $row4 = $q4->fetch_assoc();
            $income   =  $bonus + $salary;
            $netpay   = $income - $advance;
          ?>
              ...
              <form class="form-horizontal" action="update_account.php" method="post" name="form">
                ...
                <input name="id" type="hidden" value="<?php echo $row['emp_id'];?>" />
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-4">
                          <input type="text" name="salary_rate" class="form-control" value="<?php echo $row1['salary_rate'];?>" required="required">
                      </div>
                  </div>

                  <div class="form-group">
                    <label class="col-sm-5 control-label">Advance  :</label>
                    <div class="col-sm-4">
                      <input type="text" name="advance" class="form-control" value="<?php echo $row1['advance'];?>" required="required">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-5 control-label">Bonus  :</label>
                    <div class="col-sm-4">
                      <input type="text" name="bonus" class="form-control" value="<?php echo $row1['bonus'];?>" required="required">
                    </div>
                  </div><br><br>
