...
.main {
    ...
    font-size: 28px; /* Incre500d text to enable scrolling */
    padding: 0px 10px;500
...
<div class="sidenav">
    <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php"><span style="color:LightGoldenRodYellow ">Enterprise resource planning System <span></a>
            </div>
    ...
    <nav >
                  ...
                  <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="index.php"><i class="fas fa-columns "></i>Home</a>
                    </li>
                    ...
                    <li>
                    	...
                    	<li>
                        <a href="home_payment.php"><i class="fa fa-inr "></i> Payment Reports</a>
                    </li>
                    <li>
